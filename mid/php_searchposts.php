        ...
        <div class="divider dropdown-divider"></div>
         ...
         <div class="divider dropdown-divider"></div>
   		...
   		<div class="col col-lg-6">
        	<p style="color:CornflowerBlue; font-size: 25px;">Search Assigned Tasks</p>
   		</div>
...
<button type="submit" onclick="if(document.getElementById('trillPost').value == '') notify('You gotta say somethin...');" class="btn btn-primary mb-2">S E A R C H</button>
</div>
</form>
</div>
</div>
          ...
          if(isset($_POST['trillPost']) && $_POST['trillPost'] != '')
          		{
          			...
          			$response = $trillDB->searchPosts($_POST['trillPost']);
                foreach($response as $row => $col) {
                  echo $row;
                }
          			unset($_POST);
                }
